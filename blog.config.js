...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SimonSun', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'LLM Rookie🤯', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://simons-blog-eight.vercel.app/', // 网站地址
